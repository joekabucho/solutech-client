<template>
  <div v-if="currentSupplier" class="edit-form">
      ...
      <div class="form-group">
        ...
        <select name="supply_id" id="supply_id">
          <option
            ...
            :key="index"
            v-for="(supply, index) in supplyData"
            :value="supply.id"
            >{{ supply.name }}</option
          >
        </select>
    ...
    <button class="badge badge-danger mr-2" @click="deleteSupplier">
      Delete
    </button>

    <button type="submit" class="badge badge-success" @click="updateSupplier">
      Update
    </button>
    <p>{{ message }}</p>
  </div>
...
import SuppliersproductsService from "../apis/supplierproductservice";
