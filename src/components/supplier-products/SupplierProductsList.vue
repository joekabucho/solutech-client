  ...
  <div class="list row">
    <div class="col-md-8">
      <button class="m-3 btn btn-sm btn-success">
        <router-link to="/add-supplier-products" class="nav-link">Add</router-link>
      </button>
    </div>
    <div class="col-md-6">
      ...
      <ul class="list-group">
        ...
        >
          ...
          <button class="m-3 btn btn-sm btn-danger" @click="removeSupplier(supplier.id)">
            Remove All
          </button>
        </li>
      </ul>
    ...
    <div class="col-md-6">
      <div v-if="currentSupplier">
        <h4>Name</h4>
        <div>
          <label><strong>Supplier id:</strong></label> {{ currentSupplier.supply_id }}
          <label><strong>Product id:</strong></label> {{ currentSupplier.product_id }}
